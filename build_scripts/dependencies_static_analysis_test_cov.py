...
def check_stylelint():
    ...
    """
    call_subprocess("npx stylelint eagleeye/*.css")
...
def check_lint():
    ...
    """
    call_subprocess("python3 -m pylint eagleeye/ test/ build_scripts/ ")
...
def check_cyclomatic_complexity():
    ...
    """
    call_subprocess("python3 -m lizard eagleeye test build_scripts -X> CC.xml")
...
def check_dead_code():
    ...
    call_subprocess("python3 -m vulture --min-confidence 70 "
                    "eagleeye test build_scripts whitelist.py")
...
def test_coverage():
    ...
    """
    call_subprocess('python3 -m pytest test --capture=sys --cov-config=.coveragerc --cov-report "html" --cov=eagleeye')
